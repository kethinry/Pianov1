...
=======
	...
	int count=0 ;
	int count_tmp=0;
>>>>>>> 5df681c6ee48e93d98f6070a09f59870e578dc39
...
>>>>>>> 5df681c6ee48e93d98f6070a09f59870e578dc39
				...
				if (Integer.parseInt(keyString[i]) >= 0)
					this.getGraphics().drawImage(img1.getImage(), x_note, y_note[i] - height_note * 22 / 45,
							height_note, width_note, img1.getImageObserver());
			}
...
>>>>>>> 5df681c6ee48e93d98f6070a09f59870e578dc39
				...
				img1 = new ImageIcon("image/note5.png");
			} else {
				img1 = new ImageIcon("image/note5.png");
			}
<<<<<<< HEAD
			this.getGraphics().drawImage(img1.getImage(), x_note, y_note[0] - height_note * 22 / 45, height_note,
					width_note, img1.getImageObserver());
=======
			else if(bitString[0].equals("s")){
				img1 = new ImageIcon("image/note5.png");
			}
