 ...
 * 日期选择器，可以指定日期的显示格式 
 */  
public class BirthDayChooser extends JPanel{  
   ...
   private static final long serialVersionUID = 4529266044762990227L;  
     ...
     */  
    public BirthDayChooser() {  
        this(new Date(),"yyyy-MM-dd");  
    }  
    public BirthDayChooser(Date date){  
       this(date, "yyyy年MM月dd日");  
    }  
    public BirthDayChooser(String format){  
        this(new Date(), format);  
    }  
    public BirthDayChooser(Date date, String format){  
        initDate=date;  
